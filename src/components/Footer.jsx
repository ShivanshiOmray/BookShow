...
const Footer = () => {
  return (
    <div className="relative bg-gradient-to-b from-gray-900 to-gray-900/95 backdrop-blur-2xl border-t border-t-gray-800">
      {/* Floating particle */}
      <FloatingParticle />
          ...
          <div className="space-y-4 text-center sm:text-left">
            ...
            <div className="flex flex-wrap gap-3 justify-center sm:justify-start">
              {["React", "Tailwind CSS", "Vite", "GoogleAPI"].map((tech) => (
                <span
                  className="px-3 py-1.5 cursor-pointer rounded-full bg-gray-800/50 text-gray-300 text-sm backdrop-blur-sm hover:bg-cyan-400/10 hover:text-cyan-400/10 hover:text-cyan-300 transition-all"
                  key={tech}
                >
                  {tech}
                </span>
